...
| # | 项目 | ⭐ | 📈 日增 | 描述 |
|:-:|------|---:|-------:|------|
| 1 | [googleworkspace/cli](https://github.com/googleworkspace/cli) | 13,208 | +5056 | 谷歌工作空间CLI 一个命令行工具用于驱动,Gmail,日历,文件,聊天,管理员等.从谷歌发现服务动... |
| 2 | [openai/symphony](https://github.com/openai/symphony) | 6,562 | +2863 | 交响曲将项目工作转化为孤立的,自主执行运行, |
| 3 | [phuryn/pm-skills](https://github.com/phuryn/pm-skills) | 2,694 | +2050 | 总部技能市场:100多个代理技能,命令和插件从发现到策略,执行,推出和增长. |
...
| 5 | [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) | 62,552 | +1446 | 经纪人利用性能优化系统,技能,本能,记忆,安全,以及对克劳德代码,Codex,Cowork等领域的研... |
| 6 | [anthropics/skills](https://github.com/anthropics/skills) | 85,659 | +1115 | Agent Skills公共代码库。 |
| 7 | [obra/superpowers](https://github.com/obra/superpowers) | 72,414 | +1031 | 提供一个有效的代理技能框架和软件开发方法. |
| 8 | [VoltAgent/awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) | 29,287 | +992 | 5,400+技能从官方OpenClaw技能登记册中过和分类. |
| 9 | [QwenLM/Qwen-Agent](https://github.com/QwenLM/Qwen-Agent) | 14,339 | +759 | Agent framework and applications built upon Qwen>=... |
| 10 | [anomalyco/opencode](https://github.com/anomalyco/opencode) | 117,139 | +758 | 开源编码代理。 |
| 11 | [x1xhlol/system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) | 128,785 | +702 | 完整增强代码、Claude Code、Cluely、CodeBuddy、Comet、Cursor、D... |
| 12 | [TheCraigHewitt/seomachine](https://github.com/TheCraigHewitt/seomachine) | 1,972 | +646 | 专业的Claude Code工作空间,用于为任何企业创建长形式的SEO优化的博客内容. 该系统帮助您... |
| 13 | [sickn33/antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills) | 20,805 | +592 | The Ultimate Collection of 900+ Agentic Skills for... |
| 14 | [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 24,613 | +521 | 一个跨平台桌面所有在一个助理工具,用于克劳德代码,Codex,OpenCode & Gemini C... |
| 15 | [abhigyanpatwari/GitNexus](https://github.com/abhigyanpatwari/GitNexus) | 10,352 | +502 | 吉特尼克斯:零服务器代码智能引擎 - GitNexus是一个客户端知识图表创建器,完全运行在浏览器中... |
| 16 | [aidenybai/react-grab](https://github.com/aidenybai/react-grab) | 5,788 | +501 | Select context for coding agents directly from you... |
| 17 | [shareAI-lab/learn-claude-code](https://github.com/shareAI-lab/learn-claude-code) | 22,093 | +491 | 是你需要的 - 一个像纳米克劳德代码的代理,从0到1构建 |
| 18 | [badlogic/pi-mono](https://github.com/badlogic/pi-mono) | 20,600 | +471 | AI agent toolkit: coding agent CLI, unified LLM AP... |
| 19 | [gsd-build/get-shit-done](https://github.com/gsd-build/get-shit-done) | 25,160 | +447 | 对于TÂCHES的Claude Code,一个轻量级而强大的超级提示,文本工程和基于规格的开发系统. |
| 20 | [anthropics/claude-code](https://github.com/anthropics/claude-code) | 74,546 | +440 | Claude Code 是一个代理式编码工具，存在于您的终端中，理解您的代码库，并通过执行常规任务、... |
...
<p align="center"><sub>✨ 自动整理 · 2026-03-06 21:30:37</sub></p>
