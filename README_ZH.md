...
| # | 项目 | ⭐ | 📈 日增 | 描述 |
|:-:|------|---:|-------:|------|
| 1 | [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) | 66,295 | +2419 | 经纪人利用性能优化系统,技能,本能,记忆,安全,以及对克劳德代码,Codex,Cowork等领域的研... |
| 2 | [phuryn/pm-skills](https://github.com/phuryn/pm-skills) | 5,434 | +1444 | 总部技能市场:100多个代理技能,命令和插件从发现到策略,执行,推出和增长. |
| 3 | [VoltAgent/awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) | 31,375 | +1144 | 5,400+技能从官方OpenClaw技能登记册中过和分类. |
| 4 | [googleworkspace/cli](https://github.com/googleworkspace/cli) | 15,854 | +1019 | 谷歌工作空间CLI 一个命令行工具用于驱动,Gmail,日历,文件,聊天,管理员等.从谷歌发现服务动... |
| 5 | [openai/symphony](https://github.com/openai/symphony) | 9,037 | +747 | 交响曲将项目工作转化为孤立的,自主执行运行, |
| 6 | [obra/superpowers](https://github.com/obra/superpowers) | 73,682 | +643 | 提供一个有效的代理技能框架和软件开发方法. |
| 7 | [anthropics/skills](https://github.com/anthropics/skills) | 86,991 | +624 | Agent Skills公共代码库。 |
| 8 | [gsd-build/get-shit-done](https://github.com/gsd-build/get-shit-done) | 26,142 | +601 | 对于TÂCHES的Claude Code,一个轻量级而强大的超级提示,文本工程和基于规格的开发系统. |
| 9 | [shareAI-lab/learn-claude-code](https://github.com/shareAI-lab/learn-claude-code) | 23,577 | +583 | 是你需要的 - 一个像纳米克劳德代码的代理,从0到1构建 |
| 10 | [anomalyco/opencode](https://github.com/anomalyco/opencode) | 118,160 | +503 | 开源编码代理。 |
| 11 | [Shubhamsaboo/awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) | 100,784 | +493 | 使用OpenAI、Anthropic、Gemini及开源模型构建的AI代理与RAG技术驱动的优秀LL... |
| 12 | [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | 25,874 | +476 | 通过使用沙盒,记忆,工具,技能和副本,它可以处理不同层次的任务,可能需要几分钟到几个小时. |
| 13 | [twostraws/SwiftUI-Agent-Skill](https://github.com/twostraws/SwiftUI-Agent-Skill) | 1,256 | +371 | 对于克劳德代码,Codex和其他人工智能工具的SwiftUI代理技能. |
| 14 | [sickn33/antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills) | 21,621 | +359 | The Ultimate Collection of 900+ Agentic Skills for... |
| 15 | [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | 38,371 | +355 | An AI SKILL that provide design intelligence for b... |
| 16 | [anthropics/claude-code](https://github.com/anthropics/claude-code) | 75,204 | +341 | Claude Code 是一个代理式编码工具，存在于您的终端中，理解您的代码库，并通过执行常规任务、... |
| 17 | [superset-sh/superset](https://github.com/superset-sh/superset) | 5,753 | +328 | 智能化代理时代的IDE - 在机器上运行一个克劳德代码,Codex等的军队 |
| 18 | [abhigyanpatwari/GitNexus](https://github.com/abhigyanpatwari/GitNexus) | 10,963 | +318 | 吉特尼克斯:零服务器代码智能引擎 - GitNexus是一个客户端知识图表创建器,完全运行在浏览器中... |
...
| 20 | [f/prompts.chat](https://github.com/f/prompts.chat) | 150,734 | +304 | 前身为Awesome ChatGPT Prompts。分享、发现和收集社区中的提示词。免费开源——可... |
...
<p align="center"><sub>✨ 自动整理 · 2026-03-08 21:31:14</sub></p>
